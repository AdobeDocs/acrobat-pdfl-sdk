...
For more information, see [Scene](JS_3D_API.md#50552849_53181).

### Canvas object

Represents a rectangular region into which a `Scene` is rendered from a particular viewpoint.

For more information, see [Canvas](JS_3D_API.md#50552849_64381).
...
For more information, see [Runtime](JS_3D_API.md#50552849_89312).
...
For more information, see [Resource](JS_3D_API.md#50552849_90660) and [Image](JS_3D_API.md#50552849_33825).

### Event handlers

There are several types of event handlers:

- [CameraEventHandler](JS_3D_API.md#50552849_44478)
- [KeyEventHandler](JS_3D_API.md#50552849_64405)
- [MouseEventHandler](JS_3D_API.md#50552849_88510)
- [MenuEventHandler](JS_3D_API.md#50552849_88392)
- [RenderEventHandler](JS_3D_API.md#50552849_90292)
- [ScrollWheelEventHandler](JS_3D_API.md#50552849_17926)
- [SelectionEventHandler](JS_3D_API.md#50552849_72461)
- [TimeEventHandler](JS_3D_API.md#50552849_37976)
- [ToolEventHandler](JS_3D_API.md#50552849_36913)

Each one responds to a different type of event during simulation. They use a callback mechanism to run a function when an event occurs. The event is passed as an argument to the event handler^s `onEvent` function so that it can be queried when the function runs. Event handlers are registered via the [addEventHandler](JS_3D_API.md#50552849_22923) method, of the `Runtime` object.

### CameraEvent

A `CameraEvent` is created when a View is selected.

For more information, see [CameraEvent](JS_3D_API.md#50552849_70741).
...
For more information, see [KeyEvent](JS_3D_API.md#50552849_34637).
...
For more information, see [MenuEvent](JS_3D_API.md#50552849_35098).
...
For more information, see [MouseEvent](JS_3D_API.md#50552849_10766).
...
For more information, see [RenderEvent](JS_3D_API.md#50552849_39788).

### ScrollWheelEvent

A `ScrollWheelEvent` object is created when the mouse scroll wheel is activated over an active 3D `Canvas` object.

For more information, see [ScrollWheelEvent](JS_3D_API.md#50552849_36231).
...
For more information, see [SelectionEvent](JS_3D_API.md#50552849_25964).
...
For more information, see [TimeEvent](JS_3D_API.md#50552849_41486).
...
For more information, see [ToolEvent](JS_3D_API.md#50552849_36004).
