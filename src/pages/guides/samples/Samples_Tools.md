...
In Visual Studio, create a new project by clicking on **New Project** or by choosing the File > New > Project command. Select “Visual C++ Projects” in the Project Types pane. Choose **Acro9PIWiz** in the Templates pane. Enter a name and location for the project and click OK.
