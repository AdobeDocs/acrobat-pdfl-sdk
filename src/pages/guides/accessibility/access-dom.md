...
For details, see the [PDF Reference](https://www.adobe.com/go/pdfreference).
...
The set of owners and attributes is open-ended, but the standard structure attributes for Tagged PDF are defined in the [PDF Reference](https://www.adobe.com/go/pdfreference). See the table below for accessibility attributes.
