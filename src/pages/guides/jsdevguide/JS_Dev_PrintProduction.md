...
| printParams | The PrintParams object containing the printing settings.  -  The `printParams` parameter is available in Acrobat 6.0 or later. If this parameter is passed, it is passed as a literal object and any other parameters are ignored. |
