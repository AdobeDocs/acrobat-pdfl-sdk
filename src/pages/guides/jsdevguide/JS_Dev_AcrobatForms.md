...
- [Field properties](JS_Dev_AcrobatForms.md#37986)
- [Button fields](JS_Dev_AcrobatForms.md#28613)
- [Check box fields](JS_Dev_AcrobatForms.md#85887)
- [Combo box fields](JS_Dev_AcrobatForms.md#44065)
- [List box fields](JS_Dev_AcrobatForms.md#53749)
- [Radio button fields](JS_Dev_AcrobatForms.md#34428)
- [Signature fields](JS_Dev_AcrobatForms.md#61295)
- [Text fields](JS_Dev_AcrobatForms.md#64180)
- [Validation scripts](JS_Dev_AcrobatForms.md#34131)
- [Calculation script](JS_Dev_AcrobatForms.md#68521)
...
If the `cDIPath` parameter is specified, which is the case in this example, the importIcon method can only be executed in batch and console events; however, this restrictions can be bypassed using the techniques discussed in [Executing privileged methods in a non-privileged context](JS_Dev_Contexts.md#30303). When `cDIPath` is not specified, the script works for Acrobat Reader.
...
Full documentation of the objects used in the above sample script can be found in the [Acrobat JavaScript API Reference](https://www.adobe.com/go/acrobatsdk_jsapiref).
...
1. Accessing a list from another field
...
| charLimit | Limit on number of characters in area |  |
| comb | Comb of characters subject to limitation set by `charLimit` |  |
| defaultValue | Set a default text string |  |
| doNotScroll | Permit scrolling of long text |  |
| doNotSpellCheck | Set spell checking |  |
| fileSelect | Format field as a file path |  |
| multiline | Allow multiple lines in the area |  |
| password | Use special formatting to protect the user’s password |  |
| richText | Set rich text formatting |  |
...
The technique of referencing individual widgets is especially useful with radio button fields, see [Radio button fields](JS_Dev_AcrobatForms.md#34428) for additional discussion and examples.
...
- [Positioning form fields](JS_Dev_AcrobatForms.md#38340)
- [Duplicating form fields](JS_Dev_AcrobatForms.md#58000)
- [Creating multiple form fields](JS_Dev_AcrobatForms.md#92085)
...
Create a button using the Button tool as described in [Creating a submit button](JS_Dev_AcrobatForms.md#64898), above. On the Actions tab of the Button Properties dialog box, use the Mouse Up trigger and select the Reset a Form action. Click the Add button to select which fields you want to reset to their default values.
...
Unless this command is executed in a privileged context, see [Privileged versus non-privileged context](JS_Dev_Contexts.md#76421), the mail client will appear to the user.
...
Additional discussion and examples, see [Global object security policy](JS_Dev_AcrobatForms.md#59406).
...
The new global security policy places restrictions on document access to global variables. For more information and exceptions, see [Enable the global object security policy](JS_Dev_AcrobatForms.md#43014).
...
Create a custom keystroke script (see the Format tab in the Properties dialog box for any text field or combo box) in which you examine the value of `event.change`. By altering this value, you can alter the user’s input as it takes place. See the discussion of the [Text fields](JS_Dev_AcrobatForms.md#64180).
...
The properties and methods of the `TTS` object are summarized in the following two tables, [TTS properties](JS_Dev_AcrobatForms.md#66182) and [TTS methods](JS_Dev_AcrobatForms.md#35410), see`Acrobat JavaScript API Reference <[https://www.adobe.com/go/acrobatsdk\_jsapiref](https://www.adobe.com/go/acrobatsdk_jsapiref)>`\_\_ for more details.
...
As you learned earlier in [Signature fields](JS_Dev_AcrobatForms.md#61295), you can lock any form fields you deem appropriate once a document has been signed. In addition, you can also encrypt a document.
...
See the [Acrobat JavaScript API Reference](https://www.adobe.com/go/acrobatsdk_jsapiref) for documentation on these properties and methods.
