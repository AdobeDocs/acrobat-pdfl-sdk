...
The Commenting toolbar provides reviewers with the tools necessary to create comments, which may be placed in the document in the form of notes, highlighting, and other markup. In this section, you are introduced to the various annotation types from the JavaScript point of view. In [Getting annotation data](JS_Dev_RMA.md#59776) you will learn how to extract content from comments and later, in [Setting comment properties](JS_Dev_RMA.md#32848), you will learn to set the properties of a comment.
...
Additional discussion can be found in [Sorting comments](JS_Dev_RMA.md#33122). See the *JavaScript for Acrobat API Reference* or full descriptions of these parameters.
...
Refer to the [Acrobat JavaScript API Reference](https://www.adobe.com/go/acrobatsdk_jsapiref) for full descriptions of the properties specified above.
...
The object literal, `myProps`, can be used again to change the properties of a collection of annotations, perhaps ones returned by the `getAnnots`, as discussed in [Getting annotation data](JS_Dev_RMA.md#59776).
...
- [Reviewing documents with additional usage rights](JS_Dev_RMA.md#97742)
- [Emailing PDF documents](JS_Dev_RMA.md#33983)
- [JavaScript-based collaboration driver](JS_Dev_RMA.md#53029)
- [Spell-checking in comments and forms](JS_Dev_RMA.md#93532)
- [Approval](JS_Dev_RMA.md#31420)
...
- [Selecting, moving, and deleting comments](JS_Dev_RMA.md#39621)
- [Using the comments list](JS_Dev_RMA.md#13970)
- [Exporting and importing comments](JS_Dev_RMA.md#79147)
- [Comparing comments in two PDF documents](JS_Dev_RMA.md#69782)
- [Aggregating comments for use in Excel](JS_Dev_RMA.md#68889)
- [Extracting comments in a batch process](JS_Dev_RMA.md#78138)
...
- ANSB\_None: Do not sort.
- ANSB\_Page: Sort by page number.
- ANSB\_Author: Sort by author.
- ANSB\_ModDate: Sort by modification date.
- ANSB\_Type: Sort by annotation type.
