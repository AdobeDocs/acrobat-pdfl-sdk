...
1. Ignoring pdfmark if not defined in the PostScript interpreter
...
1. Handling individual pdfmark features
...
- Names for user-defined named objects (see [User-defined named objects](pdfmark_Syntax.md#50454537_72745))
- Names for stored implicit parent stacks (see StStore)
- Names for images (see [Named images (NI)](pdfmark_Basic.md#50454556_14682))
