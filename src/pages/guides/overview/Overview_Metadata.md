...
Plug-ins can also get or set XMP metadata. Furthermore, you can get or set the XMP metadata associated with an internal PDF dictionary or stream. For more information, see the [Acrobat and PDF Library API Reference](https://www.adobe.com/go/pdflibrary).
...
If a PDF document is untagged, you can convert it to a tagged PDF document using Acrobat Professional DC. Acrobat Standard provides only minimal support for tagging and no way to review or repair accessibility problems.
...
For more information on accessibility support in PDF files, see the [PDF Reference](https://www.adobe.com/go/pdfreference). For more information on implementing accessibility support, see the Acrobat Help and the [Acrobat JavaScript Developer Guide](http://www.adobe.com/go/acrobatsdk_jsdevguide).
...
Third-party developers must insert OC ProcSet information into the PostScript stream. For more information, see [Creating PDF files from an authoring application](Overview_PDFCreation.md#43214) and the [Acrobat Distiller API Reference](http://www.adobe.com/go/distiller).
...
For more information, see [Acrobat JavaScript Developer Guide](http://www.adobe.com/go/acrobatsdk_jsdevguide).
...
For more information, see the [Acrobat and PDF Library API Reference](https://www.adobe.com/go/pdflibrary).
