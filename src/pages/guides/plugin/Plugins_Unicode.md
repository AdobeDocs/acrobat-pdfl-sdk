...
| ASFileSysCreatePathName(“Folder<br><br>PathName”) | ASFileSysCreatePathName(“FolderPathName<br><br>WithASText”) |
| ASFileSysCreatePathName(“DIPath”) | ASFileSysCreatePathName(“DIPathWithAS<br><br>Text”) |
...
The [SnippetRunner samples](../snippet/index.md) include a shared snippet named OpenUnicodeNamedDocSnip that demonstrates how to open a file with a Unicode (UTF-8) file name.
