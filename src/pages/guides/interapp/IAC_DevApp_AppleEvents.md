...
| Acrobat-specific events  E | ents that are specific to Acrobat. |
...
- For information on Apple events supported by the Acrobat Search plug-in, see the [PDF Library documentation](https://www.adobe.com/go/pdflibrary).
