...
| --- | --- |
| fullPath | The full path of the file to be opened, including the .pdx extension. |
...
| --- | --- |
| Parameter | Description |
| fullPath | The full path of the file to be purged, including the .pdx extension. |
